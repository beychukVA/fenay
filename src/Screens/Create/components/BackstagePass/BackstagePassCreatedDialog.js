...
export const BackstagePassCreatedDialog = ({
  isBackstagePassCreatedDialogOpne,
  setBackstagePassCreatedDialogOpne,
}) => {
  ...
  return (
    <Dialog
      ...
      open={isBackstagePassCreatedDialogOpne}
      maxWidth={"lg"}
      //   onClose={() => setBackstagePassCreatedDialogOpne(false)}
    ...
    >
      ...
      >
        <Box
          ...
          //   onClick={() => setBackstagePassCreatedDialogOpne(false)}
          onClick={() => navigate("/")}
        />
        <Box
          sx={{
        ...
        >
          ...
          >
            Your backstage pass is under review.
          </Typography>
          <Typography
            sx={{
              fontFamily: "Work Sans",
