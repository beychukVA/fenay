...
export const SongCreatedDialog = ({
  isSongCreatedDialogOpne,
  setSongCreatedDialogOpne,
}) => {
  ...
  return (
    <Dialog
      ...
      open={isSongCreatedDialogOpne}
      maxWidth={"lg"}
      //   onClose={() => setSongCreatedDialogOpne(false)}
    ...
    >
      ...
      >
        <Box
          ...
          //   onClick={() => setSongCreatedDialogOpne(false)}
          onClick={() => navigate("/")}
        />
        <Box
          sx={{
