...
export const EventCreatedDialog = ({
  isEventCreatedDialogOpne,
  setEventCreatedDialogOpne,
}) => {
  ...
  return (
    <Dialog
      ...
      open={isEventCreatedDialogOpne}
      maxWidth={"lg"}
      //   onClose={() => setEventCreatedDialogOpne(false)}
    ...
    >
      ...
      >
        <Box
          ...
          //   onClick={() => setEventCreatedDialogOpne(false)}
          onClick={() => navigate("/")}
        />
        <Box
          sx={{
